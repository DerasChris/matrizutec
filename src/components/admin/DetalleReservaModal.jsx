...
import { X, Clock, Calendar, MapPin, User, Bookmark, MessageSquare, Edit2, History } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { ESTADOS_RESERVA_LABEL, ESTADOS_RESERVA_COLOR, ESTADOS_RESERVA } from '../../lib/constants';
...
export default function DetalleReservaModal({ reserva, onCerrar, onActualizado }) {
  ...
  const puedeEditar = esAdmin() && reserva.estado === ESTADOS_RESERVA.APROBADA;
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg my-8">
          ...
          <div className="px-5 py-4 space-y-4">
            ...
            {reserva.modificadaPorNombre && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-2.5 flex items-center gap-2 text-xs">
            ...
            <div>
              {puedeEditar && (
                <button
                  ...
                  className="px-3 py-2 text-sm bg-utec-primary text-white rounded-lg hover:bg-utec-dark flex items-center gap-1.5 font-medium"
                >
                  <Edit2 size={14} />
                  Editar
                </button>
